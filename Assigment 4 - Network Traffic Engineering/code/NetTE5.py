...
t.convert()
t.save("../report/tables/" + filename.replace(".dat", "_") + "netTE5.tex")
# export to tex
...
t.convert()
t.save("../report/tables/" + filename.replace(".dat", "_") + "netTE5_stats1.tex")
# export to tex
...
t.convert()
t.save("../report/tables/" + filename.replace(".dat", "_") + "netTE5_stats2.tex")
# export to tex
