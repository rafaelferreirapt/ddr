...
t.convert()
t.save("../report/tables/" + filename.replace(".dat", "_") + "netTE3.tex")
# export to tex
...
t.convert()
t.save("../report/tables/" + filename.replace(".dat", "_") + "netTE3_stats1.tex")
# export to tex
...
t.convert()
t.save("../report/tables/" + filename.replace(".dat", "_") + "netTE3_stats2.tex")
# export to tex
